...
class NLPModel(object):
    ...
    def pickle_vectorizer(self, path=r'path of the folder that you wish to store your pickle files/CountVectorizer.pkl'):
    ...
    def pickle_clf(self, path=r'path of the folder that you wish to store your pickle files/FitaraClassifier.pkl'):
